...
![Visual Intuition Behind FSPL](https://cdn-images-1.medium.com/max/3840/1*u2Mu0eiDdHJHoXWJ-CdckQ.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
<center>FSPL(dB) = 20 log₁₀(d) + 20 log₁₀(f) + 92.45</center>
...
![USGS’s EarthExplorer](https://cdn-images-1.medium.com/max/3200/1*cAAX1ThvaYA0SK8VjKrkNA.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/2272/1*u0W_Iyc8RRNBJ182dIGnkw.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/2000/1*JZbIZd-PmAzl0mIAb9FtRw.png){:style="display:block; margin-left:auto; margin-right:auto"}

Seaborn’s `pairplot()` function plots every feature against the others, helpful for revealing correlation between features.

![](https://cdn-images-1.medium.com/max/2000/1*bgQXH2lolZVYfGBu0dM7HQ.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/2340/1*YbZ_6bTElMgNCrOQGH8eow.png){:style="display:block; margin-left:auto; margin-right:auto"}

However, most features (such as transmission frequency vs power loss) do not show clear relationships:

![](https://cdn-images-1.medium.com/max/2340/1*fRZy6ny7hZXIVuJU2-5tdQ.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/2648/1*yOXQep8DUkiqKJL2XXi30g.png){:style="display:block; margin-left:auto; margin-right:auto"}

### Boosted Tree Ensembles

Boosted Tree Ensembles are fairly distinct from the other two model architectures, so I started there. I used `XGBoost` (eXtreme Gradient Boosting) an open source implementation for building my model. It has proven to be highly competitive in ML competitions such as those hosted by Kaggle and has training times orders of magnitude faster than traditional ML architectures. A non-customized model also requires almost no code, as can be seen below:

<script src="https://gist.github.com/connor-passe/31e2b4987a41bc8f558aa983b3823197.js"></script>
...
![](https://cdn-images-1.medium.com/max/2000/1*Z3kNEDRS35GpeeAuhVb4CA.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
<script src="https://gist.github.com/connor-passe/f1ac35417064c9bc487c2ea5f2acb35a.js"></script>
...
![](https://cdn-images-1.medium.com/max/3240/1*6RFqs2v6ZfvJXsTBgrOUkg.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/3266/1*4xKlfJZJaHOYS100Tx4fcQ.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
<script src="https://gist.github.com/connor-passe/f834d49c76f23fb017f00b127c2b7685.js"></script>

After compiling, the NN is fit and the learning curve plotted:

![](https://cdn-images-1.medium.com/max/3240/1*GKjvKWS5052zch7wH2MsUQ.png){:style="display:block; margin-left:auto; margin-right:auto"}

![](https://cdn-images-1.medium.com/max/3266/1*R3idS3x_XZVLgdsb8CQoIA.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/2000/1*pYVeHkQOXjbgYgx_AzDzbA.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/2000/1*vr76Jdow3LPTZbgBx-F9cQ.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
![](https://cdn-images-1.medium.com/max/3186/1*-LE8-raEetw7LLJub3qCww.png){:style="display:block; margin-left:auto; margin-right:auto"}
...
<script src="https://gist.github.com/connor-passe/28c3a15601a37d4ed3220b1e94dfffa6.js"></script>
...
<script src="https://gist.github.com/connor-passe/c994ec2a04cd31aa09d2a67bb4e0cead.js"></script>

## Next Steps: Building the Mobile App

Check out the companion article [here](https://connorpasse.com/projects/2022/11/15/iOSApp.html) to see the process of building an iOS app capable of performing signal propagation modeling on-device.
